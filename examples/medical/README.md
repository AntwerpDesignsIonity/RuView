...
### How This Connects to AEDI-S

This example is part of the [AEDI-S](https://github.com/ruvnet/AEDI-S) ambient intelligence platform. When combined with WiFi CSI sensing:
