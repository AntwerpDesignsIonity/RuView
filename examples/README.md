...
Real-time sensing applications built on the AEDI-S platform.
...
|---------|---------|-------------|
| [**aedis_live.py**](aedis_live.py) | CSI + mmWave + Light | Unified dashboard: HR, BR, BP, stress, presence, light, RSSI |
...
# CSI only (no mmWave)
python examples/aedis_live.py --csi COM7 --mmwave none
```
