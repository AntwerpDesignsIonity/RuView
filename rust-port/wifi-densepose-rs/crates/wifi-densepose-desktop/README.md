...
AEDI-S Desktop provides a unified interface for node discovery, firmware management, over-the-air updates, WASM edge module deployment, real-time sensing data visualization, and mesh network topology monitoring — all from a single native application.
...
Pre-built binaries are available on the [Releases](https://github.com/ruvnet/AEDI-S/releases) page.

| Platform | Download | Status |
|----------|----------|--------|
| Windows x64 | [v0.3.0-alpha](https://github.com/ruvnet/AEDI-S/releases/tag/v0.3.0-desktop-alpha) | Debug build |
| macOS | — | Planned |
| Linux | — | Planned |
...
cd AEDI-S/rust-port/wifi-densepose-rs/crates/wifi-densepose-desktop/ui
