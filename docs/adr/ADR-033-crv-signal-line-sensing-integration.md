...
| **Relates to** | ADR-016 (RuVector Integration), ADR-017 (RuVector Signal+MAT), ADR-024 (AETHER Embeddings), ADR-029 (RuvSense Multistatic), ADR-030 (Persistent Field Model), ADR-031 (AEDI-S Viewpoint Fusion), ADR-032 (Mesh Security) |
...
| ADR-031 (AEDI-S Viewpoint Fusion) | **Complementary**: AEDI-S fuses viewpoints within a room; CRV convergence matches identities across rooms |
