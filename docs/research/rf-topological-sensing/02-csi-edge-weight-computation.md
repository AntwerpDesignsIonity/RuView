...
**Research Document 02** | AEDI-S Project | March 2026
...
This is the core metric used in the AEDI-S coherence gate. For a window of $W$
...
is the variant used in the AEDI-S coherence gate.
...
The AEDI-S tomography module uses ISTA with an $\ell_1$ penalty for voxel-space
...
variance). The AEDI-S longitudinal module uses Welford statistics for
...
The AEDI-S coherence module uses Z-score-based gating to classify link quality:
...
The edge weight computation maps to existing AEDI-S crate structure:
...
*Document prepared for the AEDI-S project. Last updated March 2026.*
