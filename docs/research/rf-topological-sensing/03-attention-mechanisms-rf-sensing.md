...
## A Comprehensive Survey for WiFi-DensePose / AEDI-S
...
### 9.4 Relation to AEDI-S Codebase

The unified architecture maps directly to existing AEDI-S modules:

| Architecture Layer | AEDI-S Module | File |
|---|---|---|
...
design choices in the AEDI-S/WiFi-DensePose RF topological sensing system.*
