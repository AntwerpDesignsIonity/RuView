...
RuvSense is the multistatic WiFi sensing subsystem of AEDI-S. It turns raw radio signals from multiple ESP32 sensors into tracked human poses, vital signs, and spatial awareness — all without cameras.
